...
// EventFolder pages
const EventFolderCreate = Loadable(lazy(() => import('./pages/EventFolderCreate')));
const EventFolderList = Loadable(lazy(() => import('./pages/EventFolderList')));
// ImageUploads
const ImagesUploadsCreate = Loadable(lazy(() => import('./pages/ImageUploadCreate')));
const ImagesUploadsList = Loadable(lazy(() => import('./pages/ImageUploadList')));
...
const routes: PartialRouteObject[] = [
  ...
  },
  {
    ...
    children: [
      {
        path: 'imageslist',
        element: <ImagesUploadsList />
      },
      {
        path: 'new',
        element: <ImagesUploadsCreate />
      }
